...
///////////////////////////////////////// Main Loop ///////////////////////////////////
void loop () {
	// this will loop until a success read
  do {
    successRead = getID();  // sets successRead to 1 when we get read from reader otherwise 0
	//----------------------------------------------------------------------------
	// code to wipe the EEPROM
  ...
  //------------------------------------------------------------------------------
  // block after reading successfully
  // check if program mode is enabled
  if (programMode) {
	  //---------------
	  // if master card was detected exit program mode
